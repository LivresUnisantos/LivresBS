                ...
                foreach ($Read->getResult() as $PedIens):
                    ...
                    if ($Read->getResult()):
                        ...
                        $optionsPdt = "<option value='comunidade' " . ($item_valor == $PrecoPdt['preco'] ? 'selected="selected"' : '') . ">(R$ " . number_format($PrecoPdt['preco'], 2, ",", ".") . ") Comboio agroecológico</option>"
                                . "<option value='lojinha' " . ($item_valor == $PrecoPdt['preco_lojinha'] ? 'selected="selected"' : '') . ">(R$ " . number_format($PrecoPdt['preco_lojinha'], 2, ",", ".") . ") Consumo consciente</option>"
                                . "<option value='mercado' " . ($item_valor == $PrecoPdt['preco_mercado'] ? 'selected="selected"' : '') . ">(R$ " . number_format($PrecoPdt['preco_mercado'], 2, ",", ".") . ") Livre Mercado</option>"
